...
const SERVICE_ICONS = {
  ...
  // 인바디·혈액 — 핏방울 하나. 가운데를 가로로 파서 '눈금'을 낸다
  // (심장은 헬스정보가 이미 쓰고 있다. 나란히 설 때 둘이 구별되어야 한다.)
  bodylab:
    '<path d="M12 2.1c4.3 4.6 6.9 8.2 6.9 11.5a6.9 6.9 0 1 1-13.8 0C5.1 10.3 7.7 6.7 12 2.1Zm-3.4 11.1v2.2h6.8v-2.2Z"/>',
